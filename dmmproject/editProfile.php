...
<div class="headerEditProfile">
	...
	{
		$avtarImage = $prefix_url.'images/avatarSmll.jpg';
	}
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
    	<tr>
        	<td valign="top" class="pane1 first" width="20%">
				...
				{
					$billBoardImage = $prefix_url.'uploads/user_'.$_SESSION['user_id'].'/billboard/'.$billBordDetails[0]['file_path'];
				}
				else
				{
					$billBoardImage = $prefix_url.'images/avatarSmll.jpg';
				}
				?>
            	<div class="data">
...
<div class="btmPanel">
    ...
    <div class="btmStrip">
        <img src="<?php echo $prefix_url;?>images/ico_info.gif" alt="" />DMMCompany The Musician's Brand
    </div>
</div>
</form>
</div>
