...
<div class="popup popupBg" id="UserLogin">
<div id="steps2">
	<div id="loginSec" class="step">
        <div class="content">
            ...
            <div class="welcomeBox">
                <div class="imgCol">
                    <img src="<?php echo HOST_URL;?>/images/img_dmm.gif" alt="DMM" />
                </div>
                <div class="txt">
            ...
            <div class="signInForm">
                <form name="SignIn" method="post" action="validateLogin.php">
                    ...
                    <div class="rhtDiv">
                        ...
                        <input id="txtPassword" class="signInput" type="password" name="txtPassword" onkeypress="return submitLoginForm(event)" />
                    </div>
                </form>
                <div class="clear"></div>
            </div>
        ...
        <div class="btmPanel">
            <ul class="rhtMenu">
                ...
                <li><a class="btnLtBlue" href="#" onClick="return validateUserLogin();">Sign In</a></li>
                <li class="clear"></li>
            </ul>
        </div>
    </div>
    ...
    <div id="forgetPassSec" class="step">
        ...
        <div class="content">
          	...
          	<div class="welcomeBox">
                <div class="imgCol"> <img src="<?php echo HOST_URL;?>/images/img_dmm.gif" alt="DMMCompany" /> </div>
