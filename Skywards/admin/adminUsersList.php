        ...
        <td align="left" valign="top" class="padding rightContent"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td  align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="bigbox">
              <tr>
                <td class="titlebox">Admin Users Listing</td>
              </tr>
                    <tr>
						<td class="paddingall border" align="left" id="reports" style="padding-left:10px;"><a href="edit_admin_user_details.php?flag=add">Add Admin User</a></td>
					</tr>          
			 	<tr>
					...
					<?php //--main table-------------------------------------------------------------------?>
							<table width="100%" border="0" cellpadding="2" cellspacing="2" class="bigbox contenttext1">
								...
								<tr>
									...
									<td align="center" class="headertable">Username</td>
								...
								//---------------------------------------------------------------------------
									...
									?>
										<tr class="<?php echo $trClass; ?>">
											...
											<td align="center" id="reports"><a href="edit_admin_user_details.php?id=<?php echo $id.$tmp_page;?>&flag=edit" style="text-decoration:none;"><?php echo $name; ?></a></td>	
											<td align="center" id="reports"><a href="edit_admin_user_details.php?id=<?php echo $id.$tmp_page;?>&flag=edit" style="text-decoration:none;"><?php echo $tblArr[$i]["username"];?></a></td>	
											<td align="center"><?php echo $tblArr[$i]["email"];?></td>
											<td align="center"><div class="changeStatus" onClick="delete_record(<?php echo $tblArr[$i]["id"];?>,'<?php echo $tableName; ?>')">Delete</div></td>
                                        </tr>										
