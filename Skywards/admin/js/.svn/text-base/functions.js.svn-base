...
function delete_record(id, tableName)
{
	...
	(
		{   									
			type: "POST", url: "deleteRecord.php", data: dataString, 
			success: 
				function(data) 
				{ 	
					//alert(data)							
...
var filter_url = url + "?page=1&filter_text=" + filter_text +"&type=filter&sval=Show"+'&search_by='+search_by;
...
function change_status_entry_story(id, tableName)
{
	// call ajax to interchange order.
	var dataString = "Id=" + id +"&tableName="+tableName;
	...
	(
		{   									
			type: "POST", url: "changeStoryStatus.php", data: dataString, 
			success: 
				function(data) 
				{	 		 
					window.location.reload();
...
function change_featured_entry_story(id, tableName)
{
	// call ajax to interchange order.
	var dataString = "Id=" + id +"&tableName="+tableName;
	...
	(
		{   									
			type: "POST", url: "changeFeaturedStoryStatus.php", data: dataString, 
			success: 
				function(data) 
				{	 		 
					window.location.reload();
...
{  
var vals = trim(obj.value);
var val_len = vals.length;
