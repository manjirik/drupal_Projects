        ...
        <td align="left" valign="top" class="padding rightContent"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<td align="center" class="headertable">Acceptance Date</td>	
			 <td align="center" class="headertable">Friend Details</td>
								...
								//---------------------------------------------------------------------------
									for($i=0; $i<$tblArrCount; $i++)
									{
										...
										$fn = $user_entry_id = $tblArr[$i]['firstname'];
										$ln = $tblArr[$i]['lastname'];
										$name= $fn . " ". $ln;
										$sky_mem_id = $tblArr[$i]['sky_mem_id'];
										$created_date = $tblArr[$i]['created_date'];
										$city_name = $tblArr[$i]['city_name'];
										$acceptance_date = $tblArr[$i]['acceptance_date'];
										$friend_details = $tblArr[$i]['friend_details'];
										//$lastname = $tblArr[$i]['lastname'];
					...
					<td align="center"><?php echo $friend_details; ?></td>	
